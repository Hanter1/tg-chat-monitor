...
2. Введите **API_ID** и **API_HASH** с [my.telegram.org/apps](https://my.telegram.org/apps).
3. Нажмите **Старт** → войдите в Telegram (телефон → код → 2FA при необходимости).
4. Вкладки **Чаты** / **Слова** — добавьте группы и ключевые слова.
5. На **Главной** включите мониторинг.
6. Совпадения появятся в **Журнале** и в системных уведомлениях.
